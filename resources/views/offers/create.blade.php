                    ...
                    <div class="relative max-w-2xl w-full px-5 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                        ...
                        <div class="divide-y divide-gray-200">
                            ...
                            <div class="pt-4 flex items-center space-x-4">
                                <a href="{{ auth()->user()->isAdmin() ? route('offers.index') : route('offers.my') }}" class="flex justify-center items-center w-full text-gray-900 px-4 py-3 rounded-md focus:outline-none border border-gray-200">
